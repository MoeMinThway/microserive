...
private final CartService cartService;
   ...
   /* public  String  name(Model model){
        model.addAttribute("productName",productService.fingbyidProduct(id));
    }*/
/*    @GetMapping({"/"})
    public String home(Model model){//pagge ka hrr
       model.addAttribute("transfer",model.containsAttribute("transfer"));  // pyan  po tae transfer
        return "home";
    }*/
    ...
    public String checkout(Product product,@ModelAttribute("total") double total){
    ...
    @GetMapping("/transfer")
    public String checkoutTransfer(@ModelAttribute("total") double total,@ModelAttribute("cartSize") int cartSize, RedirectAttributes redirectAttributes){
       ResponseEntity responseEntity= productService.transfer("mary@gmail.com","john@gmail.com",total);
            ...
            redirectAttributes.addFlashAttribute("transfer-error",true);//de ka lr p checkout-view Sii twr
